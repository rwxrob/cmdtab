...
// Format takes a command documentation format string (an extremely limited
...
// DisableEmphasis turns off emphasis (italic, bold, bolditalic) from Format().
// Note that this is package wide and must be turned on again after being
// disabled. Generally emphasis should be left on to provide a consistent user
// experience for anything built with this package
